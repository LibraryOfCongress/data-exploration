...
<html lang="en" data-content_root="../../../../../" >
  ...
  <head>
    ...
    <title>Generate a signed URL for Amazon CloudFront &#8212; Tutorials for Data Exploration</title>
...
<link rel="preload" as="script" href="../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/Lib/site-packages/boto3/examples/cloudfront';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/.venv/Lib/site-packages/boto3/examples/cloudfront.rst" target="_blank"
...
<span class="nb">print</span><span class="p">(</span><span class="n">signed_url</span><span class="p">)</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv\Lib\site-packages\boto3\examples"
        },
